...
def guess_right():
    """
    The function lets the player guess a randomly selected number
    between 1 and highest variable. After the player guessed
    correctly the function returns the guess count.
    """
    highest = int(input("Enter the highest limit for the guessing game?: "))
    num = random.randint(1, highest + 1)
