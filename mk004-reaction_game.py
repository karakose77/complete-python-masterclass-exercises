...
def reaction_game():
    ...
    print("The current timezone is " +
          f"{time.tzname[0]} with an offset of {time.timezone}")
    ...
    print("Your reaction monotonic time was " +
          f"{stop_time_m - start_time_m} seconds.")
    print("Your reaction process time is " +
          f"{stop_time_pt - start_time_pt} seconds.")
